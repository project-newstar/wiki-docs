...
或者可以手动点击右键 → Patching → Change byte 进行修改。
...
然后回来，在断点处点击右键→Edit breakpoint，然后点击三个点就可调出 idapython 的窗口，然后我这里使用 python 脚本，所以在下面选择语言为 python。
...
![img](https://e1v9dz5ylz9.feishu.cn/space/api/box/stream/download/asynccode/?code=MGI0YzNjM2VmZDdhNDVkYThlMDJjZjlmOGRiMzBiNzdfYmVZaUFXd1hKRHp0cUZnYWpvZXdvRVF5MXZlMXdkYzVfVG9rZW46UGZUN2J1NjRab1k1cHp4R2Y3c2NiVlJpbmNiXzE3Mjg5MDY4ODY6MTcyODkxMDQ4Nl9WNA)
